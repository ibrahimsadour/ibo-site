...
@section('title',' تعديل الكود '.$page_link ->title)
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.footer')}}"> قسم footer  </a>
                                </li>
                                <li class="breadcrumb-item active"> تعديل - {{$page_link -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.footer.update',$page_link -> id)}}"
                                              method="POST">
                                            @csrf
                                            <input name="id" value="{{$page_link ->id}}" type="hidden">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($page_link -> active == 1)checked @endif/>
