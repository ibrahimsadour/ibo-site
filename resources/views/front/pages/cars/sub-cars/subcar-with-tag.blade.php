                ...
                <div class="tie-row main-content-row">
                    <div class="main-content tie-col-md-8 tie-col-xs-12" role="main">
                        ...
                        <div class="entry-content entry clearfix">
                                ...
                                <h2 class="entry-sub-title margin-bottom">خدمة {{$slugTag.' '.$car ->name.' '.$subCar ->name}} في مدينة {{get_default_country()}}  بين يديك على مدارالـ 24 ساعة لجميع مدن {{get_default_country()}}</h2>
                                
                                <p>ورشة صيانة متنقلة تحتوي على افضل خدمة {{$slugTag.' '.$car ->name.' '.$subCar ->name}} في مدينة {{get_default_country()}}  لجميع  سيارات {{$car ->name.' '.$subCar ->name}} حيث لدينا كل وسائل الصيانة الحديثة والإصلاح، ويقودها فنيون مختصون وميكانيكيون ذو خبرة عالية. نستطيع أن نصل اليك أينما كنت وبسرعة عالية</p>
                                <p>{{$slugTag.' '.$car ->name.' '.$subCar ->name}} لخدمتك على مدار الـ 24 ساعة وانت على الطريق او عند البيت يتم ارسل اليك اقرب فني صيانة اليك. خدمة صيانة سيارات متنقلة بارخص الاسعار اطلب الفني الأن في {{get_default_country()}} .</p>
                                ...
                                <p>تقدم هذه الشركة خدمة {{$slugTag.' '.$car ->name.' '.$subCar ->name}} في {{get_default_country()}}  إما في المنزل أو في مكان العمل أو أينما كنت بشكل سريع ومُتقن، وهي توفر أفضل الخدمات بأفضل الأسعار، حيث تتميز بفريق فني ماهر وعلى استعداد لخدمتك مهما كان نوع سيارتك،</p>
                                
                                <h3 class="entry-sub-title margin-bottom">رقم {{$slugTag.' '.$car ->name.' '.$subCar ->name}} في {{get_default_country()}} </h3>
                                ...
                                <ul>
                                    ...
                                    <li class="maker-list-inside-article">
                                        <p>ورشة {{$slugTag}} لإصلاح وقطر المركبات: تقدم لك تلك الورشة إمكانية الحصول على خدمة {{$slugTag}} المتنقلة.. بالإضافة إلى إمكانية إصلاح المركبات في حال أن كنت متواجدًا في منطقة  {{get_default_country()}}  ، حيث تملك الخبرة في صيانة المركبات.. ويمكنها معالجة الأعطال في العديد من المركبات والتي تتمثل في الماركات الأمريكية والكورية واليابانية والألمانية وخاصة سيارات  {{$car ->name.' '.$subCar ->name}}  ..ويقدم خدماته على مدار اليوم الواحد، وبإمكانك التواصل معه من خلال الاتصال</p>
                                    </li>
                                </ul>
                                <br>
                                ...
                                <h5 class="entry-sub-title margin-bottom" >خدمة عملاء {{$slugTag.' '.$car ->name.' '.$subCar ->name}}  في {{get_default_country()}}  :</h5>
