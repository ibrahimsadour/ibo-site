...
class CitiesController extends Controller
{
    ...
    public function show_all_cities()
    {
        ...
        return view('front.pages.cities.cities_group', compact('cities','sections','articles','tags','first_articles','last_articles','page_links'));
    }
    ...
    public function show_one_city($slug)
    {
        ...
        return view('front.pages.cities.city', compact('city','sections','articles','tags','first_articles','last_articles','cars','cityTags','page_links'));
